...
```{r}
astro = read.table(file = "datos/new_astro_FM.tsv", sep = '\t', header = TRUE)
rownames(astro) = astro$gene_id
astro = astro[,-1]

neurons = read.table(file = "datos/new_neurons_FM.tsv", sep = '\t', header = TRUE)
rownames(neurons) = neurons$gene_id
neurons = neurons[,-1]
```
...
GSEA <- runTest(pre_enriquecimiento, algorithm = "classic", statistic = "ks", cutOff = pvalor)
...
```{r}
pdf("resultados_durante_enriquecimiento/procesado/distribución_pvalor.pdf")
...
pdf("resultados_durante_enriquecimiento/procesado/graficos_relaciones.pdf")
...
```{r}
svg(paste0("resultados_durante_enriquecimiento/procesado/Fisher", ".svg"), width = 8, height = 6)
...
dev.off()
svg(paste0("resultados_durante_enriquecimiento/procesado/GSEA", ".svg"), width = 8, height = 6)
...
dev.off()
svg(paste0("resultados_durante_enriquecimiento/procesado/elim", ".svg"), width = 8, height = 6)
...
dev.off()
svg(paste0("resultados_durante_enriquecimiento/procesado/weight", ".svg"), width = 8, height = 6)
...
dev.off()
svg(paste0("resultados_durante_enriquecimiento/procesado/PC", ".svg"), width = 8, height = 6)
...
dev.off()
svg(paste0("resultados_durante_enriquecimiento/procesado/weight01", ".svg"), width = 8, height = 6)
...
### Términos significativos de cada grupo
```{r}

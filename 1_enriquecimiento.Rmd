...
```{r}
printGraph(pre_enriquecimiento, GSEA, firstSigNodes = 20, fn.prefix = "gsea", pdfSW = TRUE, useInfo = "all")
printGraph(pre_enriquecimiento, elim, firstSigNodes = 10, fn.prefix = "elim", pdfSW = TRUE, useInfo = "all")
printGraph(pre_enriquecimiento, ORA, firstSigNodes = 20, fn.prefix = "ora", pdfSW = TRUE, useInfo = "all")
printGraph(pre_enriquecimiento, PC, firstSigNodes = 20, fn.prefix = "parentchild", pdfSW = TRUE, useInfo = "all")
printGraph(pre_enriquecimiento, weight, firstSigNodes = 10, fn.prefix = "weight", pdfSW = TRUE, useInfo = "all")
printGraph(pre_enriquecimiento, weight01, firstSigNodes = 10, fn.prefix = "weight01", pdfSW = TRUE, useInfo = "all")
```
